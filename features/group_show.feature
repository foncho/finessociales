Feature: Group Show
  ...
  Scenario: Show
    Given an organization "org" exists with cif: "G-12345678", name: "Wadus Red Cross", budget: "500000"
      ...
      And a target "target1" exists with name: "Programa para refugiados 1", group: group "group1", budget: "20000"
      And a target "target2" exists with name: "Programa para refugiados 2", group: group "group1", budget: "10000"
      And a target "target3" exists with name: "Programa para refugiados 3", group: group "group1", budget: "10000"
      And a target "target4" exists with name: "Programa para desemparados 1", group: group "group2", budget: "10000"
